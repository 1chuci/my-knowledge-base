function main(config) {
    ...
    config["rules"] = [
      "DOMAIN-SUFFIX,dalvdm.cc,DIRECT",
      "DOMAIN-SUFFIX,douyin.com,DIRECT",
      "DOMAIN-SUFFIX,dick.xfani.com,DIRECT",
      "DOMAIN-SUFFIX,bilibili.com,DIRECT",
      "DOMAIN-SUFFIX,cycani.org,DIRECT",
      "DOMAIN-SUFFIX,senhewenhua.com,DIRECT",
      "DOMAIN-SUFFIX,byteimg.com,DIRECT",
      "DOMAIN-SUFFIX,p3-dcd-sign.byteimg.com,DIRECT",
      "DOMAIN-SUFFIX,cycanime.com,DIRECT",
      "DOMAIN-SUFFIX,cyfz.vip,DIRECT",
      "DOMAIN-SUFFIX,czzymovie.com,DIRECT",
      "DOMAIN-SUFFIX,ctyunxs.cn,DIRECT",
      "DOMAIN-SUFFIX,shenyandayi.com,DIRECT",
      "DOMAIN-SUFFIX,lingyiwanwu.com,DIRECT",
      "DOMAIN-SUFFIX,cherry-ai.com,DIRECT",
      "DOMAIN-SUFFIX,hi2future.com,DIRECT",
      "DOMAIN-SUFFIX,h-e.top,DIRECT",
      "DOMAIN-SUFFIX,icity.ly,DIRECT",
      "DOMAIN-SUFFIX,sysbbs.com,DIRECT",
      "DOMAIN-SUFFIX,theluyuan.com,DIRECT",
